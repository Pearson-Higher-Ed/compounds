          ...
          <h3>Icon only (no changehandler connection)</h3>
            ...
            <Dropdown
              ...
              <DropdownItem checkmark selected={this.state.buttonImageSelected}
                selectedName="selected" label="image item 1" type="imageButton" imgUrl="https://lipis.github.io/flag-icon-css/flags/4x3/us.svg"
                imgHeight="10" imgWidth="20" selectValue="US" />
              <DropdownItem type="divider" />
              <DropdownItem checkmark label="image item 2" type="imageButton" imgUrl="https://lipis.github.io/flag-icon-css/flags/4x3/gb.svg"
              imgHeight="10" imgWidth="20" selectValue="GB" />
              <DropdownItem checkmark label="image item 3" type="imageButton" imgUrl="https://lipis.github.io/flag-icon-css/flags/4x3/af.svg"
              imgHeight="10" imgWidth="20" selectValue="AF" />
            </Dropdown>
            <p className="code">
              {`<Dropdown
                dropdownControlLabel="Dropdown open"
