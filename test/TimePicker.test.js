...
describe('TimePicker', () => {
  ...
  describe('Basic TimePicker Test', function() {
    ...
    it('should render the TimePicker as div element', function() {
      this.wrapper = shallow(<TimePicker id="test" labelText="test" dateFormat="hh:mm" changeHandler={() => {}} />);
      expect(this.wrapper.node.type).toEqual('div');
    });

    it('should render the TimePicker in error state', function() {
      this.wrapper = mount(<TimePicker id="test" labelText="test" dateFormat="hh:mm" changeHandler={() => {}} inputState='error' />);
    ...
    it('should render the TimePicker in readOnly state', function() {
      this.wrapper = mount(<TimePicker id="test" labelText="test" dateFormat="hh:mm" changeHandler={() => {}} inputState='readOnly' />);
    ...
    it('should render the TimePicker in disabled state', function() {
      this.wrapper = mount(<TimePicker id="test" labelText="test" dateFormat="hh:mm" changeHandler={() => {}} inputState='disabled' />);
      expect(this.wrapper.instance().state.inputStyle).toEqual('pe-textInput--basic');
    });
    ...
    it('should check classes on the main container', function() {
      this.wrapper = mount(<TimePicker id="test" labelText="test" dateFormat="hh:mm" changeHandler={() => {}} id='errorInput' className="hithere" inputState='error' errorMessage='error message' />);
      expect(this.wrapper.find('.hithere').exists()).toEqual(true);
    });

    it('should check inputState error message', function() {
      this.wrapper = mount(<TimePicker id="test" labelText="test" dateFormat="hh:mm" changeHandler={() => {}} id='errorInput' inputState='error' errorMessage='error message' />);
      expect(this.wrapper.find('.pe-input--error_message').exists()).toEqual(true);
    });

    it('should check info message', function() {
      this.wrapper = mount(<TimePicker id="test" labelText="test" dateFormat="hh:mm" changeHandler={() => {}} id='infoInput' infoMessage='info message' />);
    ...
    it('should call the changehandler', function() {
      this.wrapper = mount(<TimePicker id="test" labelText="test" dateFormat="hh:mm" changeHandler={() => {}} time changeHandler={() => {}} />);
      this.wrapper.find('input').simulate('click');
