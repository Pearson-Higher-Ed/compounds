...
export const messages = defineMessages({
  ...
  initiatingButtonText2 : {
    id             : 'initiatingButtonText2',
    description    : 'text in initiating button',
  ...
  modalSaveButtonText : {
    ...
    defaultMessage : 'Standard Button'
  },
