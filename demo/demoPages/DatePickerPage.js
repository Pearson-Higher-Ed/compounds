        ...
        <h1><a href="http://pearson-higher-ed.github.io/design/c/date-picker/">DatePicker</a></h1>
          ...
          <div className="elementContainer">
            ...
            <div className="code">
              ...
              <ul>
                <li>time:Boolean  === "render datepicker as timepicker"</li>
                <li>twentyFourHour:Boolean  === "render left timepicker in 24 hour format"</li>
                <li>endTwentyFourHour:Boolean  === "render right timepicker in 24 hour format"</li>
                <li>fancy:Boolean  === "render with fancy style"</li>
            ...
            <DatePickerRange
              ...
              endChangeHandler   = {() => console.log('end-fancy!!!')}
            />
            <p className="code">{`<DatePicker time = {true} range = {true} twentyFourHour={false} className = "" endClassName = "" id = "someGiantIdStart" endId = "someGiantIdEnd"                 twentyFourHour     = {true}
                            endTwentyFourHour  = {true} placeholder = "hh:mm" endPlaceholder = "hh:mm" inputState = "default" endInputState = "default" labelText = "Start time" endLabelText = "End time" infoMessage = "${text.textInputInfoMessage}" errorMessage = "${text.textInputErrorMessage}" endInfoMessage = "${text.textInputInfoMessage}" endErrorMessage = "${text.textInputErrorMessage}" datepickerValue = {this.state.datepickerValue9} endDatepickerValue = {this.state.datepickerValue10} changeHandler = {() => console.log("¡¡¡start-fancy")} endChangeHandler = {() => console.log("end-fancy!!!")}/>`}</p>

            <h2>DatePickerRange (basic range time 24hour):</h2>
            <DatePickerRange
              time               = {true}
              range              = {true}
              twentyFourHour     = {true}
              ...
              endChangeHandler   = {() => console.log('end-fancy!!!')}
            />
            <p className="code">{`<DatePicker time = {true} range = {true} twentyFourHour={true} className = "" endClassName = "" id = "someGiantIdStart" endId = "someGiantIdEnd" placeholder = "hh:mm" endPlaceholder = "hh:mm" inputState = "default" endInputState = "default" labelText = "Start time" endLabelText = "End time" infoMessage = "${text.textInputInfoMessage}" errorMessage = "${text.textInputErrorMessage}" endInfoMessage = "${text.textInputInfoMessage}" endErrorMessage = "${text.textInputErrorMessage}" datepickerValue = {this.state.datepickerValue9} endDatepickerValue = {this.state.datepickerValue10} changeHandler = {() => console.log("¡¡¡start-fancy")} endChangeHandler = {() => console.log("end-fancy!!!")}/>`}</p>
            ...
            <h2>DatePickerRange (basic range date):</h2>
            <DatePickerRange
              range              = {true}
              className          = ""
              endClassName       = ""
