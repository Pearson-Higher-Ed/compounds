...
describe('TextInput', () => {
  ...
  describe('Basic TextInput Test', function() {
    ...
    it('should have aria-describedby match any messages', function(){
      this.wrapper = shallow(<TextInput id="textInputTestId7" labelText="TextInput Label:" placeholder="place" changeHandler={() => {}} infoMessage="This is an info message" />);
      this.wrapper.instance().componentDidMount();
    ...
    it('should have aria-describedby match any errors', function(){
      this.wrapper = shallow(<TextInput id="textInputTestId8" labelText="TextInput Label:" placeholder="place" inputState='error' changeHandler={() => {}} errorMessage="This is an error!" />);
      this.wrapper.instance().componentDidMount();
    ...
    it('should render password', function(){
      this.wrapper = shallow(<TextInput password={true} id="pwInputTestId1" labelText="Password Label:" placeholder="place" changeHandler={() => {}} />);
      this.wrapper.instance().componentDidMount();
    ...
    it('should render "not visible" message for screen readers', function(){
      this.wrapper = shallow(<TextInput password={true} id="pwInputTestId2" labelText="Password Label:" placeholder="place" changeHandler={() => {}} />);
      this.wrapper.instance().componentDidMount();
      expect(this.wrapper.find('.pe-sr-only').text()).toEqual('Password is hidden')
    });

    it('should toggle password', function(){
      this.wrapper = shallow(<TextInput password={true} id="pwInputTestId3" labelText="Password Label:" placeholder="place" changeHandler={() => {}} />);
      this.wrapper.instance().componentDidMount();
    ...
    it('should toggle "visible" message for screen readers', function(){
      this.wrapper = shallow(<TextInput password={true} id="pwInputTestId4" labelText="Password Label:" placeholder="place" changeHandler={() => {}} />);
      this.wrapper.instance().componentDidMount();
      this.wrapper.instance().togglePassword();
      expect(this.wrapper.find('.pe-sr-only').node.props.text).toEqual(this.wrapper.find('input').node.props.intlDefaultText.isVisibleMsg)
    });
