...
const DatePickerRange = (props) => {
    ...
    const { classNameContainer, time, className, classNameEnd, fancy, range, id, datepickerValue, placeholder, inputState, labelText, changeHandler, endId, endDatepickerValue, endPlaceholder, endInputState, endLabelText, endChangeHandler, infoMessage, errorMessage, endInfoMessage, endErrorMessage, hourFormat, endHourFormat, twentyFourHour, endTwentyFourHour } = props;
...
DatePickerRange.propTypes = {
  ...
  endTwentyFourHour : PropTypes.bool
};
